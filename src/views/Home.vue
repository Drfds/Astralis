...
;">ASTRALIS</h1>
      ...
      <button @click="handleGetStart" class="border border-white rounded-full px-6 py-3 mt-8 text-white text-[20px] flex items-center gap-3 bg-[#1C1C1C] hover:bg-[#121212] hover:text-[rgb(204,204,204)] transition duration-300">
        Get start
